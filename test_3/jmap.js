...
(function ($) {
    ...
    $.fn.jmap = function (options) {
        ...
        request.open('GET', 'nhk_news_covid19_prefectures_daily_data.csv', false);  // `false` で同期リクエストになる
        request.send(null);

        const today = '2021/8/23';
        ...
        for (elements of tmp) {
            if (elements.match(today)) {
                tmpArray.push(elements);
            }
        }

        // 各行ごとにカンマで区切った文字列を要素とした二次元配列を生成
        for (var i = 0; i < tmpArray.length; ++i) {
            tmp[i] = tmpArray[i].split(',');
            result[i] = tmp[i][3];
        }
        ...
        var params = $.extend({
            ...
            onSelect: function (e, data) {
                location.href = "http://127.0.0.1:5500/" + data.alphabet + ".html";
                // alert('感染者数：%d 人'.replace('%d', (data.option.number).toLocaleString()));
            },
            ...
            areas: [
                ...
                { code: 9, name: "栃木\n" + result[8], number: result[8]},
                { code: 10, name: "群馬\n" + result[9], number: result[9]},
                { code: 11, name: "埼玉\n" + result[10], number: result[10]},
                { code: 12, name: "千葉\n" + result[11], number: result[11]},
                { code: 13, name: "東京\n" + result[12], number: result[12]},
                { code: 14, name: "神奈川\n" + result[13], number: result[13]},
                { code: 15, name: "新潟\n" + result[14], number: result[14]},
                { code: 16, name: "富山\n" + result[15], number: result[15]},
                { code: 17, name: "石川\n" + result[16], number: result[16]},
                { code: 18, name: "福井\n" + result[17], number: result[17]},
                { code: 19, name: "山梨\n" + result[18], number: result[18]},
                { code: 20, name: "長野\n" + result[19], number: result[19]},
                { code: 21, name: "岐阜\n" + result[20], number: result[20]},
                { code: 22, name: "静岡\n" + result[21], number: result[21]},
                { code: 23, name: "愛知\n" + result[22], number: result[22]},
                { code: 24, name: "三重\n" + result[23], number: result[23]},
                { code: 25, name: "滋賀\n" + result[24], number: result[24]},
                { code: 26, name: "京都\n" + result[25], number: result[25]},
                { code: 27, name: "大阪\n" + result[26], number: result[26]},
                { code: 28, name: "兵庫\n" + result[27], number: result[27]},
                { code: 29, name: "奈良\n" + result[28], number: result[28]},
                { code: 30, name: "和歌山\n" + result[29], number: result[29]},
                { code: 31, name: "鳥取\n" + result[30], number: result[30]},
                { code: 32, name: "島根\n" + result[31], number: result[31]},
                { code: 33, name: "岡山\n" + result[32], number: result[32]},
                { code: 34, name: "広島\n" + result[33], number: result[33]},
                { code: 35, name: "山口\n" + result[34], number: result[34]},
                { code: 36, name: "徳島\n" + result[35], number: result[35]},
                { code: 37, name: "香川\n" + result[36], number: result[36]},
                { code: 38, name: "愛媛\n" + result[37], number: result[37]},
                { code: 39, name: "高知\n" + result[38], number: result[38]},
                { code: 40, name: "福岡\n" + result[39], number: result[39]},
                { code: 41, name: "佐賀\n" + result[40], number: result[40]},
                { code: 42, name: "長崎\n" + result[41], number: result[41]},
                { code: 43, name: "熊本\n" + result[42], number: result[42]},
                { code: 44, name: "大分\n" + result[43], number: result[43]},
                { code: 45, name: "宮崎\n" + result[44], number: result[44]},
                { code: 46, name: "鹿児島\n" + result[45], number: result[45]},
                { code: 47, name: "沖縄\n" + result[46], number: result[46]}
            ]
        }, options);
        ...
        var prefectureCss = {
            ...
            'overflow': 'hidden',
            'white-space': (params.textNowrap) ? 'nowrap' : 'pre'
        };
